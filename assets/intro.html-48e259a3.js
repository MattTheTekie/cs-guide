import{_ as a,r as t,o as i,c as l,d as n,e as s,b as r,a as o}from"./app-3d979d38.js";const c={},p=n("h1",{id:"flutter介绍",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#flutter介绍","aria-hidden":"true"},"#"),s(" flutter介绍")],-1),d={class:"hint-container tip"},u=n("p",{class:"hint-container-title"},"提示",-1),m={href:"https://flutter.dev/",target:"_blank",rel:"noopener noreferrer"},v=o(`<h2 id="说明" tabindex="-1"><a class="header-anchor" href="#说明" aria-hidden="true">#</a> 说明</h2><p>Flutter 是谷歌的移动UI框架，可以快速在iOS和Android上构建高质量的原生用户界面。Flutter可以与现有的代码一起工作。在全世界，Flutter正在被越来越多的开发者和组织使用，并且Flutter是完全免费、开源的。</p><ul><li>快速开发<br> 毫秒级的热加载，修改后，您的应用界面会立即更新。使用丰富的、完全可定制的widget 在几分钟内构件原生界面 富有表现力和灵活的UI<br> 快速发布聚焦原生体验的功能。分层的架构允许您完全自定义，从而实现难以置信的快速渲染和富有表现力、灵活的设计。</li><li>原生性能<br> Flutter 包含了许多核心的 widget，如滚动、导航、图表和字体等，这些都可以在iOS和Android上达到原生应用一样的性能。</li><li>跨平台引擎</li></ul><div class="hint-container tip"><p class="hint-container-title">提示</p><p>国内网络原因,部分依赖可能无法下载,需要设置两个环境变量</p><div class="language-env line-numbers-mode" data-ext="env"><pre class="language-env"><code>FLUTTER_STORAGE_BASE_URL: https://storage.flutter-io.cn
