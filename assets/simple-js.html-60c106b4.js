import{_ as a,o as i,c as n,g as s,a as e}from"./app-3d979d38.js";const d={},r=e(`<h1 id="javascript-开发人员需要知道的简写技巧" tabindex="-1"><a class="header-anchor" href="#javascript-开发人员需要知道的简写技巧" aria-hidden="true">#</a> JavaScript 开发人员需要知道的简写技巧</h1><h2 id="初级篇" tabindex="-1"><a class="header-anchor" href="#初级篇" aria-hidden="true">#</a> 初级篇</h2><h3 id="_1、三目运算符" tabindex="-1"><a class="header-anchor" href="#_1、三目运算符" aria-hidden="true">#</a> 1、三目运算符</h3><p>下面是一个很好的例子，将一个完整的 if 语句，简写为一行代码。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> x <span class="token operator">=</span> <span class="token number">20</span><span class="token punctuation">;</span>
