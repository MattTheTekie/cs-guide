import{_ as e,r as o,o as i,c as l,d as n,e as d,b as t,a as s}from"./app-3d979d38.js";const c={},r=s(`<h1 id="go语言-mod模块-modules-使用" tabindex="-1"><a class="header-anchor" href="#go语言-mod模块-modules-使用" aria-hidden="true">#</a> go语言 mod模块(Modules)使用</h1><blockquote><p>Go语言从诞生之初就一直有个被诟病的问题: 缺少一个行之有效的“官方”包依赖管理工具. 其原因是在Google内部，所有人都是在一个代码库上进行开发的,因此并不是非常需要.但是Go语言变成一个社区化的工程语言之后,这个问题被放大了.</p></blockquote><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token number">1.</span> 设置 GO111MODULE
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),p={href:"https://www.melvinvivas.com/go-version-1-11-modules/",target:"_blank",rel:"noopener noreferrer"},u=s(`<p><strong>go mod模块特点</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. 模块是相关Go包的集合(即一个模块可以包含多个package,一个包package包含多个go源文件)
2. go命令直接支持使用模块
3. 模块中记录和解决对其他模块的依赖性
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>go mod命令</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>   go mod download    下载依赖的module到本地cache（默认为<span class="token variable">$GOPATH</span>/pkg/mod目录）
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-设置-go111module" tabindex="-1"><a class="header-anchor" href="#_1-设置-go111module" aria-hidden="true">#</a> 1. 设置 GO111MODULE</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>可以用环境变量 GO111MODULE 开启或关闭模块支持，它有三个可选值：off、on、auto,默认值是 auto.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-go模块使用说明" tabindex="-1"><a class="header-anchor" href="#_2-go模块使用说明" aria-hidden="true">#</a> 2. go模块使用说明</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token number">1</span>. <span class="token punctuation">(</span>GO111MODULE<span class="token operator">=</span>off,把项目放到<span class="token variable">$GOPATH</span>/src之外<span class="token punctuation">)</span>或者<span class="token punctuation">(</span>设置GO111MODULE<span class="token operator">=</span>on,把项目放到任意目录<span class="token punctuation">)</span>即可激活模块模式
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_3-2-hellomod模块目录下-创建hello-go文件-并增加以下内容" tabindex="-1"><a class="header-anchor" href="#_3-2-hellomod模块目录下-创建hello-go文件-并增加以下内容" aria-hidden="true">#</a> 3.2 hellomod模块目录下,创建hello.go文件, 并增加以下内容</h6><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> hellomod
...
<span class="token keyword">func</span> <span class="token function">TestHello</span><span class="token punctuation">(</span>t <span class="token operator">*</span>testing<span class="token punctuation">.</span>T<span class="token punctuation">)</span> <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_3-4-hellomod模块目录下-运行模块测试-go-test-v-会输出以下内容" tabindex="-1"><a class="header-anchor" href="#_3-4-hellomod模块目录下-运行模块测试-go-test-v-会输出以下内容" aria-hidden="true">#</a> 3.4 hellomod模块目录下,运行模块测试 &quot;go test -v&quot;会输出以下内容</h6><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">==</span><span class="token operator">=</span> RUN   TestHello
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_3-5-提交-hellomod-模块代码到github" tabindex="-1"><a class="header-anchor" href="#_3-5-提交-hellomod-模块代码到github" aria-hidden="true">#</a> 3.5 提交 hellomod 模块代码到github</h6><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 提交代码到github</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_3-6-回到examples目录并创建一个模块测试-testmod" tabindex="-1"><a class="header-anchor" href="#_3-6-回到examples目录并创建一个模块测试-testmod" aria-hidden="true">#</a> 3.6 回到examples目录并创建一个模块测试 testmod</h6><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 回到 examples 并创建 testmod 目录, 然后在进入 testmod 目录</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_3-7-testmod-模块中创建-main-go-文件" tabindex="-1"><a class="header-anchor" href="#_3-7-testmod-模块中创建-main-go-文件" aria-hidden="true">#</a> 3.7 testmod 模块中创建 main.go 文件</h6><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_4-2-修改-hellomod-模块-hello-test-go-文件" tabindex="-1"><a class="header-anchor" href="#_4-2-修改-hellomod-模块-hello-test-go-文件" aria-hidden="true">#</a> 4.2 修改 hellomod 模块 hello_test.go 文件</h6><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> hellomod
...
<span class="token keyword">func</span> <span class="token function">TestHello</span><span class="token punctuation">(</span>t <span class="token operator">*</span>testing<span class="token punctuation">.</span>T<span class="token punctuation">)</span> <span class="token punctuation">{</span>
 ...
 <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_4-3-提交-hellomod-模块代码" tabindex="-1"><a class="header-anchor" href="#_4-3-提交-hellomod-模块代码" aria-hidden="true">#</a> 4.3 提交 hellomod 模块代码</h6><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> <span class="token function">add</span> <span class="token builtin class-name">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_4-4-进入-testmod-模块目录-升级模块" tabindex="-1"><a class="header-anchor" href="#_4-4-进入-testmod-模块目录-升级模块" aria-hidden="true">#</a> 4.4 进入 testmod 模块目录, 升级模块</h6><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> <span class="token punctuation">..</span>/ <span class="token operator">&amp;&amp;</span> <span class="token builtin class-name">cd</span> testmod
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_5-3-提交-hellomod-模块代码" tabindex="-1"><a class="header-anchor" href="#_5-3-提交-hellomod-模块代码" aria-hidden="true">#</a> 5.3 提交 hellomod 模块代码</h6><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> checkout <span class="token parameter variable">-b</span> v3
<span class="token function">git</span> <span class="token function">add</span> <span class="token builtin class-name">.</span>
...
<span class="token function">git</span> push origin master <span class="token parameter variable">--tags</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_5-3-testmod-模块中修改-main-go-文件" tabindex="-1"><a class="header-anchor" href="#_5-3-testmod-模块中修改-main-go-文件" aria-hidden="true">#</a> 5.3 testmod 模块中修改 main.go 文件</h6><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h6 id="_5-4-testmod-模块中执行命令-go-run-main-go" tabindex="-1"><a class="header-anchor" href="#_5-4-testmod-模块中执行命令-go-run-main-go" aria-hidden="true">#</a> 5.4 testmod 模块中执行命令: go run main.go</h6><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> <span class="token punctuation">..</span>/ <span class="token operator">&amp;&amp;</span> <span class="token builtin class-name">cd</span> testmod
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>go run main.go执行结果</strong></p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code>$ <span class="token keyword">go</span> run main<span class="token punctuation">.</span><span class="token keyword">go</span>                                                 
Hello World<span class="token operator">!</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="关于直接依赖和间接依赖" tabindex="-1"><a class="header-anchor" href="#关于直接依赖和间接依赖" aria-hidden="true">#</a> 关于直接依赖和间接依赖</h2><p>比如开源软件 Kubernetes（v1.17.0版本）的 go.mod 文件中就有数十个依赖包被标记为<code>indirect</code>：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>require (
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在执行命令<code>go mod tidy</code>时，Go module 会自动整理<code>go.mod 文件</code>，如果有必要会在部分依赖包的后面增加<code>// indirect</code>注释。一般而言，被添加注释的包肯定是间接依赖的包，而没有添加<code>// indirect</code>注释的包则是直接依赖的包，即明确的出现在某个<code>import</code>语句中。</p><p>然而，这里需要着重强调的是：并不是所有的间接依赖都会出现在 <code>go.mod</code>文件中。</p><p>间接依赖出现在<code>go.mod</code>文件的情况，可能符合下面所列场景的一种或多种：</p><ul><li>直接依赖未启用 Go module</li><li>直接依赖go.mod 文件中缺失部分依赖</li></ul><h3 id="直接依赖未启用-go-module" tabindex="-1"><a class="header-anchor" href="#直接依赖未启用-go-module" aria-hidden="true">#</a> 直接依赖未启用 Go module</h3><p>如下图所示，Module A 依赖 B，但是 B 还未切换成 Module，也即没有<code>go.mod</code>文件，此时，当使用<code>go mod tidy</code>命令更新A的<code>go.mod</code>文件时，B的两个依赖B1和B2将会被添加到A的<code>go.mod</code>文件中（前提是A之前没有依赖B1和B2），并且B1 和B2还会被添加<code>// indirect</code>的注释。</p><p><img src="https://oscimg.oschina.net/oscnet/up-11e7a118e04c3ee4ffcb258bd744ab1ab13.png#id=V03F0&amp;originHeight=228&amp;originWidth=406&amp;originalType=binary&amp;ratio=1&amp;status=done&amp;style=none" alt="a"></p><p>此时Module A的<code>go.mod</code>文件中require部分将会变成：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>require (
 B vx.x.x
 B1 vx.x.x // indirect
 B2 vx.x.x // indirect
)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>依赖B及B的依赖B1和B2都会出现在<code>go.mod</code>文件中。</p><h3 id="直接依赖-go-mod-文件不完整" tabindex="-1"><a class="header-anchor" href="#直接依赖-go-mod-文件不完整" aria-hidden="true">#</a> 直接依赖 go.mod 文件不完整</h3><p>如上面所述，如果依赖B没有<code>go.mod</code>文件，则Module A 将会把B的所有依赖记录到A 的<code>go.mod</code>文件中。即便B拥有<code>go.mod</code>，如果<code>go.mod</code>文件不完整的话，Module A依然会记录部分B的依赖到<code>go.mod</code>文件中。</p><p>如下图所示，Module B虽然提供了<code>go.mod</code>文件中，但<code>go.mod</code>文件中只添加了依赖B1，那么此时A在引用B时，则会在A的<code>go.mod</code>文件中添加B2作为间接依赖，B1则不会出现在A的<code>go.mod</code>文件中。</p><p><img src="https://oscimg.oschina.net/oscnet/up-f185e4a01c63ffce70767ecdf065819100c.png#id=RK4Ku&amp;originHeight=228&amp;originWidth=406&amp;originalType=binary&amp;ratio=1&amp;status=done&amp;style=none" alt="a"></p><p>此时Module A的<code>go.mod</code>文件中require部分将会变成：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>require (
 B vx.x.x
 B2 vx.x.x // indirect
)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于B1已经包含进B的<code>go.mod</code>文件中，A的<code>go.mod</code>文件则不必再记录，只会记录缺失的B2。</p><h3 id="为什么要记录间接依赖" tabindex="-1"><a class="header-anchor" href="#为什么要记录间接依赖" aria-hidden="true">#</a> 为什么要记录间接依赖</h3><p>在上面的例子中，如果某个依赖B 没有<code>go.mod</code>文件，在A 的<code>go.mod</code>文件中已经记录了依赖B及其版本号，为什么还要增加间接依赖呢？</p><p>我们知道Go module需要精确地记录软件的依赖情况，虽然此处记录了依赖B的版本号，但B的依赖情况没有记录下来，所以如果B的<code>go.mod</code>文件缺失了（或没有）这个信息，则需要在A的<code>go.mod</code>文件中记录下来。此时间接依赖的版本号将会跟据Go module的版本选择机制确定一个最优版本。</p><h3 id="如何处理间接依赖" tabindex="-1"><a class="header-anchor" href="#如何处理间接依赖" aria-hidden="true">#</a> 如何处理间接依赖</h3><p>综上所述间接依赖出现在<code>go.mod</code>中，可以一定程度上说明依赖有瑕疵，要么是其不支持Go module，要么是其<code>go.mod</code>文件不完整。</p><p>由于Go 语言从v1.11版本才推出module的特性，众多开源软件迁移到go module还需要一段时间，在过渡期必然会出现间接依赖，但随着时间的推进，在<code>go.mod</code>中出现<code>// indirect</code>的机率会越来越低。</p><p>出现间接依赖可能意味着你在使用过时的软件，如果有精力的话还是推荐尽快消除间接依赖。可以通过使用依赖的新版本或者替换依赖的方式消除间接依赖。</p><h3 id="如何查找间接依赖来源" tabindex="-1"><a class="header-anchor" href="#如何查找间接依赖来源" aria-hidden="true">#</a> 如何查找间接依赖来源</h3><p>Go module提供了<code>go mod why</code> 命令来解释为什么会依赖某个软件包，若要查看<code>go.mod</code>中某个间接依赖是被哪个依赖引入的，可以使用命令<code>go mod why -m &lt;pkg&gt;</code>来查看。</p><p>比如，我们有如下的<code>go.mod</code>文件片断：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>require (
 github.com/Rican7/retry v0.1.0 // indirect
...
github.com/Rican7/retry
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的打印信息中<code># github.com/Rican7/retry</code> 表示当前正在分析的依赖，后面几行则表示依赖链。<code>github.com/renhongcai/gomodule</code> 依赖<code>github.com/renhongcai/indirect</code>，而<code>github.com/renhongcai/indirect</code>依赖<code>github.com/Rican7/retry</code>。由此我们就可以判断出间接依赖<code>github.com/Rican7/retry</code>是被<code>github.com/renhongcai/indirect</code>引入的。</p><p>另外，命令<code>go mod why -m all</code>则可以分析所有依赖的依赖链。</p>`,84);function m(v,g){const a=o("ExternalLinkIcon");return i(),l("div",null,[r,n("p",null,[n("a",p,[d("参考文章"),t(a)])]),u])}const h=e(c,[["render",m],["__file","go-mod.html.vue"]]);export{h as default};
