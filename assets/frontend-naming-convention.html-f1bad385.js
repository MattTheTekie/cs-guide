...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,154);function h(p,x){const l=t("ExternalLinkIcon");return s(),a("div",null,[u,o,r("more"),m,e("p",null,[i("函数(方法)注释也是多行注释的一种，但是包含了特殊的注释要求，参照 "),e("a",b,[i("javadoc(百度百科)"),v(l)]),i(" 语法：")]),g])}const q=d(c,[["render",h],["__file","frontend-naming-convention.html.vue"]]);export{q as default};
