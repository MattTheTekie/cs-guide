import{_ as n,o as s,c as a,a as e}from"./app-3d979d38.js";const i={},l=e(`<h1 id="go命令" tabindex="-1"><a class="header-anchor" href="#go命令" aria-hidden="true">#</a> go命令</h1><h2 id="go命令-1" tabindex="-1"><a class="header-anchor" href="#go命令-1" aria-hidden="true">#</a> go命令</h2><p>注意 cgo 不支持交叉编译</p><div class="language-powershell line-numbers-mode" data-ext="powershell"><pre class="language-powershell"><code><span class="token keyword">param</span> <span class="token punctuation">(</span>
