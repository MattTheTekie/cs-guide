...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="docker-单个实例部署-1-0-1" tabindex="-1"><a class="header-anchor" href="#docker-单个实例部署-1-0-1" aria-hidden="true">#</a> Docker 单个实例部署（1.0.1）</h2>`,3),H={href:"https://github.com/wurstmeister/kafka-docker",target:"_blank",rel:"noopener noreferrer"},Z=e("li",null,[n("我的服务器外网 ip："),e("code",null,"182.61.19.177"),n("，hostname 为："),e("code",null,"instance-3v0pbt5d")],-1),j=e("li",null,"在我的开发机上上配置 host：",-1),V=e("div",{class:"language-text line-numbers-mode","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`182.61.19.177 instance-3v0pbt5d
`)]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"})])],-1),Y=e("li",null,"部署 kafka：",-1),W={href:"https://github.com/wurstmeister/kafka-docker",target:"_blank",rel:"noopener noreferrer"},J=e("li",null,[n("新建文件："),e("code",null,"vim docker-compose.yml")],-1),Q=e("li",null,"这里的 kafka 对外网暴露端口是 9094，内网端口是 9092",-1),$=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>version: &#39;3.2&#39;
services:
  zookeeper:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>开发机设置 hosts：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>47.91.22.116 youmeekhost1
47.91.22.124 youmeekhost2
47.74.6.138 youmeekhost3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="zookeeper-集群" tabindex="-1"><a class="header-anchor" href="#zookeeper-集群" aria-hidden="true">#</a> Zookeeper 集群</h4><ul><li>节点 1：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d --name=zookeeper1 --net=host --restart=always \\
...
zookeeper:latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>节点 2：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d --name=zookeeper2 --net=host --restart=always \\
-v /data/docker/zookeeper/data:/data \\
-v /data/docker/zookeeper/log:/datalog \\
-v /etc/hosts:/etc/hosts \\
-e ZOO_MY_ID=2 \\
-e &quot;ZOO_SERVERS=server.1=youmeekhost1:2888:3888 server.2=youmeekhost2:2888:3888 server.3=youmeekhost3:2888:3888&quot; \\
zookeeper:latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>节点 3：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d --name=zookeeper3 --net=host --restart=always \\
-v /data/docker/zookeeper/data:/data \\
-v /data/docker/zookeeper/log:/datalog \\
-v /etc/hosts:/etc/hosts \\
-e ZOO_MY_ID=3 \\
-e &quot;ZOO_SERVERS=server.1=youmeekhost1:2888:3888 server.2=youmeekhost2:2888:3888 server.3=youmeekhost3:2888:3888&quot; \\
zookeeper:latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="先安装-nc-再来校验-zookeeper-集群情况" tabindex="-1"><a class="header-anchor" href="#先安装-nc-再来校验-zookeeper-集群情况" aria-hidden="true">#</a> 先安装 nc 再来校验 zookeeper 集群情况</h4>`,16),ee=e("li",null,"环境：CentOS 7.4",-1),ne={href:"https://nmap.org/download.html",target:"_blank",rel:"noopener noreferrer"},ie=e("li",null,[n("当前时间（201803）最新版本下载："),e("code",null,"wget https://nmap.org/dist/ncat-7.60-1.x86_64.rpm")],-1),ae=e("li",null,[n("安装并 ln："),e("code",null,"sudo rpm -i ncat-7.60-1.x86_64.rpm && ln -s /usr/bin/ncat /usr/bin/nc")],-1),se=e("li",null,[n("检验："),e("code",null,"nc --version")],-1),le=s(`<h4 id="zookeeper-集群测试" tabindex="-1"><a class="header-anchor" href="#zookeeper-集群测试" aria-hidden="true">#</a> zookeeper 集群测试</h4><ul><li>节点 1 执行命令：<code>echo stat | nc youmeekhost1 2181</code>，能得到如下信息：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Zookeeper version: 3.4.11-37e277162d567b55a07d1755f0b31c32e93c01a0, built on 11/01/2017 18:06 GMT
Clients:
...
Mode: follower
Node count: 4
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>节点 2 执行命令：<code>echo stat | nc youmeekhost2 2181</code>，能得到如下信息：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Zookeeper version: 3.4.11-37e277162d567b55a07d1755f0b31c32e93c01a0, built on 11/01/2017 18:06 GMT
Clients:
...
Mode: leader
Node count: 4
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>节点 3 执行命令：<code>echo stat | nc youmeekhost3 2181</code>，能得到如下信息：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Zookeeper version: 3.4.11-37e277162d567b55a07d1755f0b31c32e93c01a0, built on 11/01/2017 18:06 GMT
Clients:
...
Mode: follower
Node count: 4
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="kafka-集群" tabindex="-1"><a class="header-anchor" href="#kafka-集群" aria-hidden="true">#</a> Kafka 集群</h5><ul><li>节点 1 执行：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d --net=host --name=kafka1 \\
--restart=always \\
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>节点 2 执行：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d --net=host --name=kafka2 \\
--restart=always \\
...
-v /etc/hosts:/etc/hosts \\
wurstmeister/kafka:latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>节点 3 执行：</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d --net=host --name=kafka3 \\
--restart=always \\
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
	...
	<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>version</span><span class="token punctuation">&gt;</span></span>1.0.1<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>version</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>项目配置文件：bootstrap-servers 地址：<code>instance-3v0pbt5d:9092</code>（这里端口是 9092 别弄错了）</li></ul><hr><h2 id="kafka-1-0-1-默认配置文件内容" tabindex="-1"><a class="header-anchor" href="#kafka-1-0-1-默认配置文件内容" aria-hidden="true">#</a> kafka 1.0.1 默认配置文件内容</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># Licensed to the Apache Software Foundation (ASF) under one or more
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="其他资料" tabindex="-1"><a class="header-anchor" href="#其他资料" aria-hidden="true">#</a> 其他资料</h2>`,9),ye={href:"http://lsr1991.github.io/2016/01/03/kafka-consumer-group-management/",target:"_blank",rel:"noopener noreferrer"},xe={href:"http://blog.xiaoxiaomo.com/2016/05/14/Kafka-Consumer%E6%B6%88%E8%B4%B9%E8%80%85/",target:"_blank",rel:"noopener noreferrer"},Oe={href:"http://www.ituring.com.cn/article/499268",target:"_blank",rel:"noopener noreferrer"},Ke={href:"http://orchome.com/kafka/index",target:"_blank",rel:"noopener noreferrer"},Ie={href:"https://www.jianshu.com/p/263164fdcac7",target:"_blank",rel:"noopener noreferrer"},Se={href:"https://www.cnblogs.com/wangxiaoqiangs/p/7831990.html",target:"_blank",rel:"noopener noreferrer"},Re={href:"http://www.bijishequ.com/detail/536308",target:"_blank",rel:"noopener noreferrer"},Ne={href:"http://lanxinglan.cn/2017/10/18/%E5%9C%A8Docker%E7%8E%AF%E5%A2%83%E4%B8%8B%E9%83%A8%E7%BD%B2Kafka/",target:"_blank",rel:"noopener noreferrer"},Le={href:"https://www.cnblogs.com/ding2016/p/8282907.html",target:"_blank",rel:"noopener noreferrer"},Pe={href:"http://blog.csdn.net/fuyuwei2015/article/details/73379055",target:"_blank",rel:"noopener noreferrer"},ze={href:"https://segmentfault.com/a/1190000012990954",target:"_blank",rel:"noopener noreferrer"},Ce={href:"http://www.54tianzhisheng.cn/2018/01/04/Kafka/",target:"_blank",rel:"noopener noreferrer"},De={href:"https://renwole.com/archives/442",target:"_blank",rel:"noopener noreferrer"},qe={href:"http://www.bijishequ.com/detail/542646?p=85",target:"_blank",rel:"noopener noreferrer"},Fe={href:"http://blog.csdn.net/zhbr_f1/article/details/73732299",target:"_blank",rel:"noopener noreferrer"},Me={href:"http://wangzs.leanote.com/post/kafka-manager%E5%AE%89%E8%A3%85",target:"_blank",rel:"noopener noreferrer"},Be={href:"https://cloud.tencent.com/developer/article/1013313",target:"_blank",rel:"noopener noreferrer"},Ge={href:"http://blog.csdn.net/boling_cavalry/article/details/78309050",target:"_blank",rel:"noopener noreferrer"},Ue={href:"https://www.jianshu.com/p/d77149efa59f",target:"_blank",rel:"noopener noreferrer"},Xe={href:"http://www.bijishequ.com/detail/536308",target:"_blank",rel:"noopener noreferrer"},He={href:"http://blog.51cto.com/13323775/2063420",target:"_blank",rel:"noopener noreferrer"},Ze={href:"http://lanxinglan.cn/2017/10/18/%E5%9C%A8Docker%E7%8E%AF%E5%A2%83%E4%B8%8B%E9%83%A8%E7%BD%B2Kafka/",target:"_blank",rel:"noopener noreferrer"},je={href:"http://www.cnblogs.com/huxi2b/p/7929690.html",target:"_blank",rel:"noopener noreferrer"},Ve={href:"http://blog.csdn.net/HG_Harvey/article/details/79198496",target:"_blank",rel:"noopener noreferrer"},Ye={href:"http://blog.csdn.net/vtopqx/article/details/78638996",target:"_blank",rel:"noopener noreferrer"},We={href:"http://www.weduoo.com/archives/2047",target:"_blank",rel:"noopener noreferrer"},Je={href:"https://blog.52itstyle.com/archives/2358/",target:"_blank",rel:"noopener noreferrer"};function Qe($e,en){const i=t("ExternalLinkIcon");return o(),r("div",null,[c,u,e("ul",null,[v,e("li",null,[e("a",p,[n("Flink 的要求"),a(i)])]),e("li",null,[e("a",m,[n("Spark 的要求"),a(i)])]),e("li",null,[e("a",k,[n("Spring 的要求"),a(i)])])]),h,e("ul",null,[e("li",null,[n("官网："),e("a",b,[n("https://kafka.apache.org/"),a(i)])]),e("li",null,[n("Github："),e("a",f,[n("https://github.com/apache/kafka"),a(i)]),g]),e("li",null,[n("官网下载："),e("a",_,[n("https://kafka.apache.org/downloads"),a(i)])]),A,e("li",null,[n("官网 quickstart："),e("a",E,[n("https://kafka.apache.org/quickstart"),a(i)])]),w,T,e("li",null,[n("核心概念： "),e("ul",null,[y,x,O,K,I,S,e("li",null,[n("Consumer Group：每个 Consumer 属于一个特定的 Consumer Group（可为每个 Consumer 指定 group name，若不指定 group name 则属于默认的 group）一般一个业务系统集群指定同一个一个 group id，然后一个业务系统集群只能一个节点来消费同一个消息。 "),e("ul",null,[R,N,L,P,e("li",null,[n("具体实验可以看这篇文章："),e("a",z,[n("Kafka深度解析"),a(i)])])])]),C])]),e("li",null,[n("业界常用的 docker 镜像： "),e("ul",null,[e("li",null,[e("a",D,[n("wurstmeister/kafka-docker（不断更新，优先）"),a(i)])]),e("li",null,[n("Spring 项目选用依赖包的时候，对于版本之间的关系可以看这里："),e("a",q,[n("http://projects.spring.io/spring-kafka/"),a(i)]),F])])]),e("li",null,[n("官网 quickstart 指导："),e("a",M,[n("https://kafka.apache.org/quickstart"),a(i)])]),e("li",null,[n("常用命令： "),e("ul",null,[B,e("li",null,[n("更多命令可以看："),e("a",G,[n("http://orchome.com/454"),a(i)])])])]),U]),X,e("ul",null,[e("li",null,[n("目前 latest 用的时候 kafka 1.0.1，要指定版本可以去作者 "),e("a",H,[n("github"),a(i)]),n(" 看下 tag 目录，切换不同 tag，然后看下 Dockerfile 里面的 kafka 版本号")]),Z,j]),V,e("ul",null,[Y,e("li",null,[n("目前 latest 用的时候 kafka 1.0.1，要指定版本可以去作者 "),e("a",W,[n("github"),a(i)]),n(" 看下 tag 目录，切换不同 tag，然后看下 Dockerfile 里面的 kafka 版本号")]),J,Q]),$,e("ul",null,[ee,e("li",null,[n("官网下载："),e("a",ne,[n("https://nmap.org/download.html"),a(i)]),n("，找到 rpm 包")]),ie,ae,se]),le,e("ul",null,[e("li",null,[n("可以参考："),e("a",te,[n("Kafka的SASL/PLAIN认证配置说明"),a(i)])])]),oe,e("ul",null,[e("li",null,[n("Github 官网："),e("a",re,[n("https://github.com/quantifind/KafkaOffsetMonitor"),a(i)]),de])]),ce,e("ul",null,[e("li",null,[n("Github 官网："),e("a",ue,[n("https://github.com/yahoo/kafka-manager"),a(i)]),ve]),pe,e("li",null,[n("源码类安装可以看："),e("a",me,[n("Kafka监控工具—Kafka Manager"),a(i)])]),ke]),he,be,e("ul",null,[fe,ge,_e,Ae,e("li",null,[n("官网下载："),e("a",Ee,[n("https://kafka.apache.org/downloads"),a(i)])]),we]),Te,e("ul",null,[e("li",null,[e("a",ye,[n("管理Kafka的Consumer-Group信息"),a(i)])]),e("li",null,[e("a",xe,[n("Kafka--Consumer消费者"),a(i)])]),e("li",null,[e("a",Oe,[n("http://www.ituring.com.cn/article/499268"),a(i)])]),e("li",null,[e("a",Ke,[n("http://orchome.com/kafka/index"),a(i)])]),e("li",null,[e("a",Ie,[n("https://www.jianshu.com/p/263164fdcac7"),a(i)])]),e("li",null,[e("a",Se,[n("https://www.cnblogs.com/wangxiaoqiangs/p/7831990.html"),a(i)])]),e("li",null,[e("a",Re,[n("http://www.bijishequ.com/detail/536308"),a(i)])]),e("li",null,[e("a",Ne,[n("http://lanxinglan.cn/2017/10/18/在Docker环境下部署Kafka/"),a(i)])]),e("li",null,[e("a",Le,[n("https://www.cnblogs.com/ding2016/p/8282907.html"),a(i)])]),e("li",null,[e("a",Pe,[n("http://blog.csdn.net/fuyuwei2015/article/details/73379055"),a(i)])]),e("li",null,[e("a",ze,[n("https://segmentfault.com/a/1190000012990954"),a(i)])]),e("li",null,[e("a",Ce,[n("http://www.54tianzhisheng.cn/2018/01/04/Kafka/"),a(i)])]),e("li",null,[e("a",De,[n("https://renwole.com/archives/442"),a(i)])]),e("li",null,[e("a",qe,[n("http://www.bijishequ.com/detail/542646?p=85"),a(i)])]),e("li",null,[e("a",Fe,[n("http://blog.csdn.net/zhbr_f1/article/details/73732299"),a(i)])]),e("li",null,[e("a",Me,[n("http://wangzs.leanote.com/post/kafka-manager安装"),a(i)])]),e("li",null,[e("a",Be,[n("https://cloud.tencent.com/developer/article/1013313"),a(i)])]),e("li",null,[e("a",Ge,[n("http://blog.csdn.net/boling_cavalry/article/details/78309050"),a(i)])]),e("li",null,[e("a",Ue,[n("https://www.jianshu.com/p/d77149efa59f"),a(i)])]),e("li",null,[e("a",Xe,[n("http://www.bijishequ.com/detail/536308"),a(i)])]),e("li",null,[e("a",He,[n("http://blog.51cto.com/13323775/2063420"),a(i)])]),e("li",null,[e("a",Ze,[n("http://lanxinglan.cn/2017/10/18/在Docker环境下部署Kafka/"),a(i)])]),e("li",null,[e("a",je,[n("http://www.cnblogs.com/huxi2b/p/7929690.html"),a(i)])]),e("li",null,[e("a",Ve,[n("http://blog.csdn.net/HG_Harvey/article/details/79198496"),a(i)])]),e("li",null,[e("a",Ye,[n("http://blog.csdn.net/vtopqx/article/details/78638996"),a(i)])]),e("li",null,[e("a",We,[n("http://www.weduoo.com/archives/2047"),a(i)])]),e("li",null,[e("a",Je,[n("https://blog.52itstyle.com/archives/2358/"),a(i)])])])])}const an=l(d,[["render",Qe],["__file","Kafka-Install-And-Settings.html.vue"]]);export{an as default};
