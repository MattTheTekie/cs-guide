import{_ as e,o as n,c as i,a as l}from"./app-3d979d38.js";const t={},a=l(`<h1 id="nm-目标文件格式分析" tabindex="-1"><a class="header-anchor" href="#nm-目标文件格式分析" aria-hidden="true">#</a> nm 目标文件格式分析</h1><p>nm 命令显示关于指定 File 中符号的信息，文件可以是对象文件、可执行文件或对象文件库。如果文件没有包含符号信息，nm 命令报告该情况，但不把它解释为出错条件。 nm 命令缺省情况下报告十进制符号表示法下的数字值。</p><pre><code>$nm myProgrammer
08049f28 d _DYNAMIC
...
</code></pre><ul><li><p>V 该符号是一个weak object。</p></li><li><p>W The symbol is a weak symbol that has not been specifically tagged as a weak object symbol.</p></li><li><p>? 该符号类型没有定义</p></li></ul><p><em>库或对象名</em> 如果您指定了 -A 选项，则 nm 命令只报告与该文件有关的或者库或者对象名。</p><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2><ol><li>寻找特殊标识</li></ol><p>有时会碰到一个编译了但没有链接的代码，那是因为它缺失了标识符；这种情况，可以用nm和objdump、readelf命令来查看程序的符号表；所有这些命令做的工作基本一样；</p><p>比如连接器报错有未定义的标识符；大多数情况下，会发生在库的缺失或企图链接一个错误版本的库的时候；浏览目标代码来寻找一个特殊标识符的引用:</p><pre><code>nm -uCA *.o | grep foo
...
</code></pre></li></ol>`,26),_=[a];function o(s,r){return n(),i("div",null,_)}const c=e(t,[["render",o],["__file","nm.html.vue"]]);export{c as default};
