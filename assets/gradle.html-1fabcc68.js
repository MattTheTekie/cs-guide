import{_ as p,r as i,o,c as l,d as n,e as s,b as t,a as e}from"./app-3d979d38.js";const c={},u=e(`<h1 id="gradle配置" tabindex="-1"><a class="header-anchor" href="#gradle配置" aria-hidden="true">#</a> gradle配置</h1><h2 id="安卓使用libs" tabindex="-1"><a class="header-anchor" href="#安卓使用libs" aria-hidden="true">#</a> 安卓使用libs</h2><div class="language-groovy line-numbers-mode" data-ext="groovy"><pre class="language-groovy"><code> implementation <span class="token function">fileTree</span><span class="token punctuation">(</span>include<span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token string">&#39;*.jar&#39;</span><span class="token punctuation">,</span><span class="token interpolation-string"><span class="token string">&quot;*.aar&quot;</span></span><span class="token punctuation">]</span><span class="token punctuation">,</span> dir<span class="token punctuation">:</span> <span class="token string">&#39;libs&#39;</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>使用kts</p><div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code><span class="token function">implementation</span><span class="token punctuation">(</span><span class="token function">fileTree</span><span class="token punctuation">(</span><span class="token function">mapOf</span><span class="token punctuation">(</span><span class="token string-literal singleline"><span class="token string">&quot;dir&quot;</span></span> <span class="token keyword">to</span> <span class="token string-literal singleline"><span class="token string">&quot;libs&quot;</span></span><span class="token punctuation">,</span> <span class="token string-literal singleline"><span class="token string">&quot;include&quot;</span></span> <span class="token keyword">to</span> <span class="token function">listOf</span><span class="token punctuation">(</span><span class="token string-literal singleline"><span class="token string">&quot;*.jar&quot;</span></span><span class="token punctuation">,</span> <span class="token string-literal singleline"><span class="token string">&quot;*.aar&quot;</span></span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="升级gradlew" tabindex="-1"><a class="header-anchor" href="#升级gradlew" aria-hidden="true">#</a> 升级gradlew</h2>`,8),m={href:"https://docs.gradle.org/current/userguide/init_scripts.html",target:"_blank",rel:"noopener noreferrer"},g=e(`<p><code>$GRADLE_USER_HOME</code>是你gradle下载文件的位置 把下面这个命名为dependencyUpdate.gradle然后放到<code>$GRADLE_USER_HOME/init.d/</code>文件夹即可</p><div class="language-groovy line-numbers-mode" data-ext="groovy"><pre class="language-groovy"><code>
...
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不能<code>maven(&quot;https://maven.aliyun.com/repository/google/&quot;)</code></p><h3 id="安卓bom" tabindex="-1"><a class="header-anchor" href="#安卓bom" aria-hidden="true">#</a> 安卓bom</h3>`,9),b={href:"https://developer.android.google.cn/jetpack/compose/setup?hl=zh-cn#bom-version-mapping",target:"_blank",rel:"noopener noreferrer"},f=e(`<h3 id="gradle-kts" tabindex="-1"><a class="header-anchor" href="#gradle-kts" aria-hidden="true">#</a> gradle kts</h3><div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code>    <span class="token keyword">import</span> org<span class="token punctuation">.</span>gradle<span class="token punctuation">.</span>kotlin<span class="token punctuation">.</span>dsl<span class="token punctuation">.</span>apply
    ...
    tasks<span class="token punctuation">.</span><span class="token function">getByName</span><span class="token punctuation">(</span><span class="token string-literal singleline"><span class="token string">&quot;check&quot;</span></span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">dependsOn</span><span class="token punctuation">(</span><span class="token string-literal singleline"><span class="token string">&quot;lint&quot;</span></span><span class="token punctuation">)</span>
                ...
                <span class="token punctuation">}</span>
            <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安卓baseactivity的viewbinding" tabindex="-1"><a class="header-anchor" href="#安卓baseactivity的viewbinding" aria-hidden="true">#</a> 安卓baseactivity的viewbinding</h3>`,6),h={href:"https://stackoverflow.com/questions/62407823/how-to-use-viewbinding-with-an-abstract-base-class",target:"_blank",rel:"noopener noreferrer"},q=e(`<div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code><span class="token comment">/*
 * In Activity
...
<span class="token keyword">abstract</span> <span class="token keyword">class</span> ViewBindingFragment<span class="token operator">&lt;</span>VB <span class="token operator">:</span> ViewBinding<span class="token operator">&gt;</span> <span class="token operator">:</span> <span class="token function">Fragment</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dart-服务端" tabindex="-1"><a class="header-anchor" href="#dart-服务端" aria-hidden="true">#</a> dart 服务端</h3>`,3),y={href:"https://github.com/VeryGoodOpenSource/dart_frog",target:"_blank",rel:"noopener noreferrer"},w=n("h3",{id:"flutter添加到android",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#flutter添加到android","aria-hidden":"true"},"#"),s(" flutter添加到android")],-1),x={href:"https://flutter.cn/docs/development/add-to-app",target:"_blank",rel:"noopener noreferrer"},_=e(`<h3 id="splitabi" tabindex="-1"><a class="header-anchor" href="#splitabi" aria-hidden="true">#</a> splitabi</h3><p>优化ApK大小之ABI Filters 和 APK split</p><p>想要打出的 apk 包含多个架构的 so库 需要下面的配置：</p><div class="language-groovy line-numbers-mode" data-ext="groovy"><pre class="language-groovy"><code>android <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="gradle引用其他脚本的方法" tabindex="-1"><a class="header-anchor" href="#gradle引用其他脚本的方法" aria-hidden="true">#</a> gradle引用其他脚本的方法</h2><p>在build.gradle里导入自己写的脚本是用apply这个方法的map参数。设置from这个key对应的value为my.gradle的uri。这个在apply文档中有写明</p><blockquote><p>build.gradle</p></blockquote><div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token function">apply</span><span class="token punctuation">(</span><span class="token punctuation">[</span>plugin<span class="token punctuation">:</span> &#39;com<span class="token punctuation">.</span>android<span class="token punctuation">.</span>application&#39;<span class="token punctuation">,</span><span class="token named-parameter punctuation">from</span><span class="token punctuation">:</span>project<span class="token punctuation">.</span><span class="token function">uri</span><span class="token punctuation">(</span><span class="token function">file</span><span class="token punctuation">(</span><span class="token string">&quot;my.gradle&quot;</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>已经把自己的脚本加入到build.gradle里面了，那么我们就可以在my.gradle里面写方法了。 这里我只找到了一种方法来实现，那就是使用包！！！定义好包后，就把这个包添加到project的扩展属性里面。</p><blockquote><p>my.gradle</p></blockquote><div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code>def add <span class="token operator">=</span> <span class="token punctuation">{</span>
    a<span class="token punctuation">,</span>b<span class="token operator">-&gt;</span>
    <span class="token keyword">return</span> a<span class="token operator">+</span>b<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
ext<span class="token punctuation">{</span>
    <span class="token keyword">fun</span> <span class="token operator">=</span> add
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在我们就可以在build.gradle里面调用这个add方法了。</p><blockquote><p>build.gradle</p></blockquote><div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code>println <span class="token string-literal singleline"><span class="token string">&quot;resutl:&quot;</span></span><span class="token operator">+</span> ext<span class="token punctuation">.</span>fun<span class="token punctuation">.</span><span class="token function">call</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span><span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在build.gradle里导入自己写的脚本是用apply这个方法的map参数。设置from这个key对应的value为my.gradle的uri。这个在apply文档中有写明。</p><blockquote><p>build.gradle</p></blockquote><div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token function">apply</span><span class="token punctuation">(</span><span class="token punctuation">[</span>plugin<span class="token punctuation">:</span> &#39;com<span class="token punctuation">.</span>android<span class="token punctuation">.</span>application&#39;<span class="token punctuation">,</span><span class="token named-parameter punctuation">from</span><span class="token punctuation">:</span>project<span class="token punctuation">.</span><span class="token function">uri</span><span class="token punctuation">(</span><span class="token function">file</span><span class="token punctuation">(</span><span class="token string">&quot;my.gradle&quot;</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>已经把自己的脚本加入到build.gradle里面了，那么我们就可以在my.gradle里面写方法了。 这里我只找到了一种方法来实现，那就是使用包！！！定义好包后，就把这个包添加到project的扩展属性里面。</p><blockquote><p>my.gradle</p></blockquote><div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code>def add <span class="token operator">=</span> <span class="token punctuation">{</span>
    a<span class="token punctuation">,</span>b<span class="token operator">-&gt;</span>
    <span class="token keyword">return</span> a<span class="token operator">+</span>b<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,36);function C(A,E){const a=i("ExternalLinkIcon");return o(),l("div",null,[u,n("p",null,[n("a",r,[s("https://www.jianshu.com/p/892a2ca5c41e"),t(a)])]),d,n("p",null,[s("Apply Changes 是通过利用Android 8.0（API级别26）或更高版本中支持的 Android JVMTI（"),n("a",k,[s("https://docs.oracle.com/javase/8/docs/platform/jvmti/jvmti.html#bc1）技术。所以如果想使用Apply"),t(a)]),s(" Changes有两个条件：")]),v,n("p",null,[s("gradle init 脚本 "),n("a",m,[s("https://docs.gradle.org/current/userguide/init_scripts.html"),t(a)])]),g,n("p",null,[n("a",b,[s("https://developer.android.google.cn/jetpack/compose/setup?hl=zh-cn#bom-version-mapping"),t(a)])]),f,n("p",null,[n("a",h,[s("https://stackoverflow.com/questions/62407823/how-to-use-viewbinding-with-an-abstract-base-class"),t(a)])]),q,n("p",null,[n("a",y,[s("https://github.com/VeryGoodOpenSource/dart_frog"),t(a)])]),w,n("p",null,[n("a",x,[s("https://flutter.cn/docs/development/add-to-app"),t(a)])]),_])}const I=p(c,[["render",C],["__file","gradle.html.vue"]]);export{I as default};
